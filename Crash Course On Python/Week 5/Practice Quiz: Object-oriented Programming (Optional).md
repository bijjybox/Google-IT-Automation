...
# the highest elevation 
	...
	# is its elevation the highest evaluated so far?
	if min_population<=city2.population and return_city.elevation<city2.elevation:
		return_city = city2
	# Evaluate the 3rd instance to meet the requirements:
	# does city #3 have at least min_population and
	# is its elevation the highest evaluated so far?
	if min_population<=city3.population and return_city.elevation<city3.elevation:
		return_city = city3
